...
\begin{document}
  \begin{tikzpicture}
    \begin{loglogaxis}[title={Total throughput},              % Title of the graph
      ...
      \addplot table [y=throughput]{\DATAPATH/parameters1_5s/FINE.data};
      \addlegendentry{parameters1, 5s}

      \addplot table [y=throughput]{\DATAPATH/parameters2_1s/FINE.data};
      \addlegendentry{parameters2, 1s}

      \addplot table [y=throughput]{\DATAPATH/parameters2_5s/FINE.data};
